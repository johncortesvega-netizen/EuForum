...
expectIncludes("app.js", "No Sydney Protocol language trigger attached");
...
expectIncludes("data/receiptSystem.js", "sydney_language_trigger");
expectIncludes("data/protocolRules.js", "Language-trigger receipts only");
